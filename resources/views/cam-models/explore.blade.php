...
@section('title'){{ __('seo.explore_title', ['category' => $pageTitle]) }}@endsection
@section('meta_description'){{ __('seo.explore_desc', ['category_lc' => strtolower($categoryLabels[$category] ?? $categoryLabels[null])]) }}@endsection
