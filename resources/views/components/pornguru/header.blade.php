        ...
        <div class="nav-right">
            ...
            <div class="lang-selector" id="lang-selector">
                ...
                <div class="lang-selector-dropdown">
                    ...
                    @php
                        // Use translated URLs when available (tag/country pages with translated slugs)
                        if (isset($langSwitchUrls[$loc])) {
                            $langUrl = $langSwitchUrls[$loc];
                        } else {
                            $path = request()->path();
